...
describe('GET /todos/:id', () => {
  ...
  it('should not be able to fetch todo created by other user', (done) => {
    request(app)
  ...
  it('should fetch nothing for non existing id', (done) => {
    request(app)
      .get(`/todos/${todos[1]._id.toHexString()}123`)
      .set('x-auth', users[0].tokens[0].token)
      .expect(404)
      .expect((res) => {
        expect(res.body.todo).toBe(undefined);
...
describe('DELETE /todos/:id', () => {
  ...
  it('should delete nothing for unexisting id', (done) => {
    request(app)
      .delete(`/todos/${todos[0]._id.toHexString()}123`)
      .set('x-auth', users[0].tokens[0].token)
      .expect(404)
      .expect((res) => {
        expect(res.body.todo).toBe(undefined);
